...
| Resize Mode | `imageResizeMode` | image | resize | options | no | `nodes/DavixH2I/DavixH2I.node.ts` |
| Enlarge Mode | `imageEnlargeMode` | image | resize | options | no | `nodes/DavixH2I/DavixH2I.node.ts` |
...
| Resize Mode | `multitaskResizeMode` | image | multitask | options | no | `nodes/DavixH2I/DavixH2I.node.ts` |
| Enlarge Mode | `multitaskEnlargeMode` | image | multitask | options | no | `nodes/DavixH2I/DavixH2I.node.ts` |
...
- **Internal name:** `imageEnlargeMode`
- **Location:** Resource `image` → Operation `resize`
- **Type:** `options`
- **Required:** `no`
- **Default value:** `automatic`
- **Display conditions:** `{ show: { resource: ['image'], operation: ['resize'] } }`
- **Options (if dropdown):** `automatic`, `enabled`, `disabled`
- **Maps to request parameter:** `enlarge`
- **Transformation behavior:** `automatic` omits `enlarge`; `enabled` sends `enlarge=true`; `disabled` sends `enlarge=false` (stringified in multipart form data).
- **Evidence:** `nodes/DavixH2I/DavixH2I.node.ts` (field definition and resize request mapping).
...
- **Internal name:** `multitaskEnlargeMode`
- **Location:** Resource `image` → Operation `multitask` with `actions` including `resize`
- **Type:** `options`
- **Required:** `no`
- **Default value:** `automatic`
...
- **Options (if dropdown):** `automatic`, `enabled`, `disabled`
- **Maps to request parameter:** `enlarge`
- **Transformation behavior:** `automatic` omits `enlarge`; `enabled` sends `enlarge=true`; `disabled` sends `enlarge=false` for multitask resize mapping.
- **Evidence:** `nodes/DavixH2I/DavixH2I.node.ts` (field definition and multitask resize request mapping).
...
| `imageResizeMode` | `{ show: { resource: ['image'], operation: ['resize'] } }` | When displayOptions `show` conditions are not met. | `nodes/DavixH2I/DavixH2I.node.ts` |
| `imageEnlargeMode` | `{ show: { resource: ['image'], operation: ['resize'] } }` | When displayOptions `show` conditions are not met. | `nodes/DavixH2I/DavixH2I.node.ts` |
...
| `multitaskResizeMode` | `{ show: { resource: ['image'], operation: ['multitask'], actions: ['resize'] } }` | When displayOptions `show` conditions are not met. | `nodes/DavixH2I/DavixH2I.node.ts` |
| `multitaskEnlargeMode` | `{ show: { resource: ['image'], operation: ['multitask'], actions: ['resize'] } }` | When displayOptions `show` conditions are not met. | `nodes/DavixH2I/DavixH2I.node.ts` |
