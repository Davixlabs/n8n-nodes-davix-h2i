...
| image | resize | Process uploaded image(s) with width/height, resizeMode, and tri-state enlarge behavior (automatic/enabled/disabled). | `nodes/DavixH2I/DavixH2I.node.ts:L110`, `nodes/DavixH2I/DavixH2I.node.ts:L1416-L1423` |
